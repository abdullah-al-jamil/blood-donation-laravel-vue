...
const navItems = [
  ...
  { name: 'Manage Donors', path: '/admin/donors', icon: '👥' },
  { name: 'Blood Inventory', path: '/admin/inventory', icon: '📦' },
  { name: 'Blood Requests', path: '/admin/requests', icon: '📋' },
  { name: 'Donation Centers', path: '/admin/centers', icon: '🏢' },
  { name: 'Appointments', path: '/admin/appointments', icon: '📅' },
  { name: 'Donations', path: '/admin/donations', icon: '❤️' },
]
